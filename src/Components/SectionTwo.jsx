...
//             </p>
//             <div className="flex space-x-3 items-center justify-center"> {/* Slightly more space between buttons */}
//   <a 
//     href="https://play.google.com/store/apps/details?id=YOUR_PACKAGE_ID" 
//     target="_blank" 
//     rel="noopener noreferrer"
//     className="flex items-start bg-black text-white px-4 py-2.5 rounded-lg hover:bg-gray-800 transition-colors text-base"   >
//     <svg  xmlns="http://www.w3.org/2000/svg"  width="22"  height="22"  viewBox="0 0 24 24"  fill="currentColor"  className="mr-2" /* Slightly more icon spacing */ >
...
//     target="_blank" 
//     rel="noopener noreferrer"
//     className="flex items-center bg-black text-white px-4 py-2.5 rounded-lg hover:bg-gray-800 transition-colors text-base" 
//     /* Increased padding and text-base */
//   >
//     <svg 
...
//       viewBox="0 0 24 24" 
//       fill="currentColor" 
//       className="mr-2" /* Slightly more icon spacing */
//     >
...
//             {/* <button
//               type="button"
//               className="btn-header" > Get Started
//             </button> */}
//           </div>
//           <div>
//             <img src={padel} className="hover-image" alt="padel racket Image" />
//           </div>
//         </div>
//       </header>
//     </div>
